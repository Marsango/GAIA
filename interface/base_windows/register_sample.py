...
class RegisterSampleDialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(773, 767)
        Dialog.setMaximumSize(QSize(800, 767))
        ...
        self.frame_35 = QFrame(Dialog)
        self.frame_35.setObjectName(u"frame_35")
        self.frame_35.setFrameShape(QFrame.StyledPanel)
        self.frame_35.setFrameShadow(QFrame.Raised)
        self.groupBox_10 = QGroupBox(self.frame_35)
        self.groupBox_10.setObjectName(u"groupBox_10")
        self.groupBox_10.setGeometry(QRect(158, 10, 413, 70))
        self.groupBox_10.setMinimumSize(QSize(0, 0))
        self.groupBox_10.setMaximumSize(QSize(500, 70))
        self.horizontalLayout_41 = QHBoxLayout(self.groupBox_10)
        self.horizontalLayout_41.setObjectName(u"horizontalLayout_41")
        self.frame_37 = QFrame(self.groupBox_10)
        self.frame_37.setObjectName(u"frame_37")
        self.frame_37.setMinimumSize(QSize(0, 0))
        self.frame_37.setMaximumSize(QSize(120, 16777215))
        self.frame_37.setFrameShape(QFrame.NoFrame)
        self.horizontalLayout_42 = QHBoxLayout(self.frame_37)
        self.horizontalLayout_42.setObjectName(u"horizontalLayout_42")
        self.label_34 = QLabel(self.frame_37)
        self.label_34.setObjectName(u"label_34")
        self.label_34.setMaximumSize(QSize(49, 20))

        self.horizontalLayout_42.addWidget(self.label_34)

        self.sand_input = QLineEdit(self.frame_37)
        self.sand_input.setObjectName(u"sand_input")
        self.sand_input.setMaximumSize(QSize(50, 20))

        self.horizontalLayout_42.addWidget(self.sand_input)
        ...
        self.frame_38.setMaximumSize(QSize(170, 16777215))
        self.frame_38.setFrameShape(QFrame.NoFrame)
        self.horizontalLayout_43 = QHBoxLayout(self.frame_38)
        ...
        self.silte_input = QLineEdit(self.frame_38)
        self.silte_input.setObjectName(u"silte_input")
        self.silte_input.setMaximumSize(QSize(50, 16777215))

        self.horizontalLayout_43.addWidget(self.silte_input)


        self.horizontalLayout_41.addWidget(self.frame_38)

        self.frame_43 = QFrame(self.groupBox_10)
        self.frame_43.setObjectName(u"frame_43")
        self.frame_43.setMaximumSize(QSize(170, 16777215))
        self.frame_43.setFrameShape(QFrame.NoFrame)
        self.horizontalLayout_50 = QHBoxLayout(self.frame_43)
        ...
        self.clay_input = QLineEdit(self.frame_43)
        self.clay_input.setObjectName(u"clay_input")
        self.clay_input.setMaximumSize(QSize(50, 16777215))

        self.horizontalLayout_50.addWidget(self.clay_input)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_10.setTitle(QCoreApplication.translate("Dialog", u"Granulometria", None))
        self.label_34.setText(QCoreApplication.translate("Dialog", u"Areia (%):", None))
        self.label_35.setText(QCoreApplication.translate("Dialog", u"Silte (%):", None))
        self.label_40.setText(QCoreApplication.translate("Dialog", u"Argila (%):", None))
