...
class UploadLogoDialog(object):
    ...
    def retranslateUi(self, UploadLogo):
        ...
        self.label.setText(QCoreApplication.translate("UploadLogo", u"Para uma melhor qualidade, sugere-se o tamanho da imagem 500x500px e fundo transparente.", None))
